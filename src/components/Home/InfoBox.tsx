    ...
    <div className="container__info-box">
      ...
      <div className={`expander ${isInfoBoxOpen ? "expanded" : ""}`}>
        <div className={`expander-content ${isInfoBoxOpen ? "expanded" : ""}`}>
          <p>
            Billy Myles-Berkouwer is a full-stack web developer, visual artist,
            and technical lead on 3D web projects for clients in arts and
            commercial sectors. With strong interpersonal and technical skills,
            he is comfortable working across various project phases, including
            art direction, 3D design and asset creation, 3D animation, and
          ...
          <ul className="list__social-links">
            <li>
              <a href="https://www.linkedin.com/in/billyberkouwer">LinkedIn</a>
            </li>
            <li>
              <a href="https://www.instagram.com/billyberkouwer/">Instagram</a>
            </li>
            <li>
              <a href="https://github.com/billyberkouwer">GitHub</a>
            </li>
          </ul>
        </div>
      </div>
